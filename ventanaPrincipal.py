...
################################################################################
## Form generated from reading UI file 'mockupFinal.ui'
##
...
class Ui_VentanaPrincipal(object):
    def setupUi(self, VentanaPrincipal):
        ...
        VentanaPrincipal.setFixedSize(1000, 700)
        ...
        self.frame_botones_superiores = QFrame(self.frame_izquierda)
        self.frame_botones_superiores.setObjectName(u"frame_botones_superiores")
        self.frame_botones_superiores.setFrameShape(QFrame.Shape.StyledPanel)
        self.frame_botones_superiores.setFrameShadow(QFrame.Shadow.Raised)
        self.horizontalLayout_2 = QHBoxLayout(self.frame_botones_superiores)
        self.horizontalLayout_2.setObjectName(u"horizontalLayout_2")

        self.btn_venta_productos = QPushButton(self.frame_botones_superiores)
        self.btn_venta_productos.setObjectName(u"btn_venta_productos")
        self.btn_venta_productos.pressed.connect(self.menu_ventas)

        self.horizontalLayout_2.addWidget(self.btn_venta_productos)

        self.btn_stock = QPushButton(self.frame_botones_superiores)
        self.btn_stock.setObjectName(u"btn_stock")

        self.horizontalLayout_2.addWidget(self.btn_stock)

        self.btn_cambios = QPushButton(self.frame_botones_superiores)
        self.btn_cambios.setObjectName(u"btn_cambios")

        self.horizontalLayout_2.addWidget(self.btn_cambios)

        self.btn_reportes = QPushButton(self.frame_botones_superiores)
        self.btn_reportes.setObjectName(u"btn_reportes")

        self.horizontalLayout_2.addWidget(self.btn_reportes)


        self.verticalLayout_3.addWidget(self.frame_botones_superiores)

        self.pila_menu = QStackedWidget(self.frame_izquierda)
        self.pila_menu.setCurrentIndex(2)
...
"    }")
        ...
        self.fecha_ventas_dia.setDate(QDate.currentDate())
        ...
        self.pila_menu.setCurrentIndex(3)
    ...
    def retranslateUi(self, VentanaPrincipal):
        ...
        self.combo_medio_pago.setPlaceholderText(QCoreApplication.translate("VentanaPrincipal", u"Efectivo", None))
        self.label_monto_total.setText(QCoreApplication.translate("VentanaPrincipal", u"$120.000,00", None))
