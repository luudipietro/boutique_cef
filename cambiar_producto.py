...
def crear_items_detalle(id):
    widgets = []
    for id, nombre, imagen, talle, cantidad in detalle_venta(id):
        widgets.append(crear_widget(id, nombre, imagen, talle, cantidad))
    return widgets

def crear_widget(id, nombre, imagen, talle, cantidad):
    widget = QWidget()
